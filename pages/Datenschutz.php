<?php
$root      = '../';
$pageTitle = 'Datenschutz – Jason Holweg';
$pageDesc  = 'Datenschutzerklärung gemäß DSGVO für die Website von Jason Holweg.';
include '../includes/header.php';
?>

<header class="page-hero" role="banner">
  <div class="orb" style="width:400px;height:400px;top:-60px;left:-80px;background:radial-gradient(circle,rgba(16,185,129,0.18),transparent 70%)"></div>
  <div class="container" style="position:relative;z-index:1">
    <p class="section-label">Rechtliches</p>
    <h1 class="fade-up"><span class="grad-text">Datenschutz</span></h1>
  </div>
</header>
  ...
  <section class="legal-page section">
    <div class="container">
      <div class="glass fade-up">
        ...
        <h2>2. Hosting</h2>
        <p>
          Wir hosten die Inhalte unserer Website bei einem externen Dienstleister (Hoster). Personenbezogene Daten, die auf dieser Website erfasst werden, werden auf den Servern des Hosters gespeichert. Hierbei kann es sich v. a. um IP-Adressen, Kontaktanfragen, Meta- und Kommunikationsdaten, Vertragsdaten, Kontaktdaten, Namen, Websitezugriffe und sonstige Daten, die über eine Website generiert werden, handeln.
        </p>
